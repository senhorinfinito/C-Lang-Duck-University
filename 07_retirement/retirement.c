...
// We'll remove the effects of inflation by keeping everything in  "today's dollars" and
...
// We're going to model both savings (while working) and expenditure
...
double compute_earning(double balance, double rate, double contribution){
